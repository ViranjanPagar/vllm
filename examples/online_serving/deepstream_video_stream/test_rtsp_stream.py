            ...
            for raw_line in resp.iter_lines():
                ...
                if content:
                    ...
                    if max_segments is not None and segments_received >= max_segments:
                        print(f"\nReached --segments {max_segments} limit, disconnecting.")
                        break
...
def main():
    ...
    parser.add_argument("--frames",   type=int,   default=8,    help="Frames per segment")
    parser.add_argument("--tokens",   type=int,   default=256,  help="Max output tokens")
    parser.add_argument("--segments", type=int,   default=None, help="Stop after N segments")
